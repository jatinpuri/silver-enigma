...
pd.DataFrame(rows).to_csv('turbo_200k_08pct_1trade_day_buffer4k_summary.csv',index=False)
pd.DataFrame(pays).to_csv('turbo_200k_08pct_1trade_day_buffer4k_payouts.csv',index=False)
pd.DataFrame(br).to_csv('turbo_200k_08pct_1trade_day_buffer4k_breaches.csv',index=False)
